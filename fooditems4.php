...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <div class="w3-quarter">
      <img src="ice cream.jpg" alt="Sandwich" width=100 height="100">
      <h3>Ice Cream</h3>
      <p>Cost: 7</p>
    </div>
    <div class="w3-quarter">
      <img src="idhyappam.jpg" alt="Steak" width=100 height="100">
      <h3>Idhiyappam</h3>
      <p>Cost: 8</p>
    </div>
    <div class="w3-quarter">
      <img src="idli.jpg" alt="Cherries" width=100 height="100">
      <h3>Idli</h3>
      <p>Cost: 7</p>
      
    </div>
    <div class="w3-quarter">
      <img src="imli chutney.jpg" alt="Pasta and Wine" width=100 height="100">
      <h3>Imli Chutney</h3>
      <p>Cost: 4</p>
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    <div class="w3-quarter">
      <img src="jeera rice.jpg" alt="Popsicle" width=100 height=100>
      <h3>Jeera Rice</h3>
      <p>Cost: 5</p>
    </div>
    <div class="w3-quarter">
      <img src="kadai chole masala.jpg" alt="Salmon" width=100 height="100">
      <h3>Kadai Chole Masala</h3>
      <p>Cost: 7</p>
    </div>
    <div class="w3-quarter">
      <img src="kadai paneer.jpg" alt="Sandwich" width=100 height="100">
      <h3>Kadai Paneer</h3>
      <p>Cost: 10</p>
    </div>
    <div class="w3-quarter">
      <img src="kara kazhambhu.jpg" alt="Croissant" width=100 height="100">
      <h3>Kara Kazhambhu</h3>
      <p>Cost: 7</p>
    </div>
  </div>
