...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <div class="w3-quarter">
      <img src="butter chicken.jpg" alt="Sandwich" width=100 height="100">
      <h3>Butter Chicken</h3>
      <p>Cost: 12</p>
    </div>
    <div class="w3-quarter">
      <img src="butter milk.jpg" alt="Steak" width=100 height="100">
      <h3>Butter milk</h3>
      <p>Cost: 7</p>
    </div>
    <div class="w3-quarter">
      <img src="chana masala.jpg" alt="Cherries" width=100 height="100">
      <h3>Chana masala</h3>
      <p>Cost: 10</p>
      
    </div>
    <div class="w3-quarter">
      <img src="channa dal.jpg" alt="Pasta and Wine" width=100 height="100">
      <h3>Channa dal</h3>
      <p>Cost: 10</p>
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    <div class="w3-quarter">
      <img src="chapati.jpg" alt="Popsicle" width=100 height=100>
      <h3>Chapati</h3>
      <p>Cost: 2</p>
    </div>
    <div class="w3-quarter">
      <img src="chicken biryani.jpg" alt="Salmon" width=100 height="100">
      <h3>Chicken Biryani</h3>
      <p>Cost: 10</p>
    </div>
    <div class="w3-quarter">
      <img src="dal makhani.jpg" alt="Sandwich" width=100 height="100">
      <h3>Dal makhani</h3>
      <p>Cost: 10</p>
    </div>
    <div class="w3-quarter">
      <img src="chily chicken gravy.jpg" alt="Croissant" width=100 height="100">
      <h3>Chily Chicken Gravy</h3>
      <p>Cost: 12</p>
    </div>
  </div>
