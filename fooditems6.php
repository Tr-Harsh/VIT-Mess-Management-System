...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <div class="w3-quarter">
      <img src="malai paneer.jpg" alt="Sandwich" width=100 height="100">
      <h3>Malai Paneer</h3>
      <p>Cost: 10</p>
    </div>
    <div class="w3-quarter">
      <img src="manchurian gravy.jpg" alt="Steak" width=100 height="100">
      <h3>Manchurian Gravy</h3>
      <p>Cost: 8</p>
    </div>
    <div class="w3-quarter">
      <img src="pav bhaji.jpg" alt="Cherries" width=100 height="100">
      <h3>Pav bhaji</h3>
      <p>Cost: 5</p>
      
    </div>
    <div class="w3-quarter">
      <img src="noodles.jpg" alt="Pasta and Wine" width=100 height="100">
      <h3>Noodles</h3>
      <p>Cost: 7</p>
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    <div class="w3-quarter">
      <img src="mutter paneer.jpg" alt="Popsicle" width=100 height=100>
      <h3>Mutter Paneer</h3>
      <p>Cost: 7</p>
    </div>
    <div class="w3-quarter">
      <img src="payasam.jpg" alt="Salmon" width=100 height="100">
      <h3>Payasam</h3>
      <p>Cost: 8</p>
    </div>
    <div class="w3-quarter">
      <img src="rajma.jpg" alt="Sandwich" width=100 height="100">
      <h3>Rajma</h3>
      <p>Cost: 4</p>
    </div>
    <div class="w3-quarter">
      <img src="paneer paratha.jpg" alt="Croissant" width=100 height="100">
