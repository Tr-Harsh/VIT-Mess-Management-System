...
<nav class="w3-sidebar w3-bar-block w3-card-2 w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  <a href="find.php" onclick="w3_close()" class="w3-bar-item w3-button">North Mess</a>
  <a href="find.php" onclick="w3_close()" class="w3-bar-item w3-button">South Mess</a>
  <a href="find.php" onclick="w3_close()" class="w3-bar-item w3-button">Special Mess</a>
</nav>
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-right w3-padding-16"><a href="index.html">Home</a></div>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <div class="w3-quarter">
      <img src="fried aloo.jpg" alt="Sandwich" width=100 height="100">
      <h3>Fried Aloo</h3>
      <p>Cost: 7</p>
    </div>
    <div class="w3-quarter">
      <img src="fried rice.jpg" alt="Steak" width=100 height="100">
      <h3>Fried Rice</h3>
      <p>Cost: 8</p>
    </div>
    <div class="w3-quarter">
      <img src="fruits.jpg" alt="Cherries" width=100 height="100">
      <h3>Fruits</h3>
      <p>Cost: 7</p>
      
    </div>
    <div class="w3-quarter">
      <img src="ghee.jpg" alt="Pasta and Wine" width=100 height="100">
      <h3>Ghee</h3>
      <p>Cost: 4</p>
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    <div class="w3-quarter">
      <img src="gobhi fry.jpg" alt="Popsicle" width=100 height=100>
      <h3>Gobhi Fry</h3>
      <p>Cost: 5</p>
    </div>
    <div class="w3-quarter">
      <img src="gobi manchurian.jpg" alt="Salmon" width=100 height="100">
      <h3>Gobhi Machurian</h3>
      <p>Cost: 7</p>
    </div>
    <div class="w3-quarter">
      <img src="green moong masala.jpg" alt="Sandwich" width=100 height="100">
      <h3>Green Moong Masala</h3>
      <p>Cost: 10</p>
    </div>
    <div class="w3-quarter">
      <img src="gulaab jamun.jpg" alt="Croissant" width=100 height="100">
      <h3>Gulaab Jamun</h3>
      <p>Cost: 7</p>
    </div>
  </div>
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      ...
      <a href="fooditems6.php" class="w3-bar-item w3-button w3-hover-black">»</a>
    </div>
  </div>
